module github.com/davidwalter0/tools
...
require (
	...
	github.com/dominikh/go-tools v0.0.0-20190215041234-466a0476246c
	github.com/duo-labs/webauthn v0.0.0-20190225193304-76dd83f95125
